...
## Как пользоваться скриптом. Установка с протоколом XHTTP
...
```sh
wget -qO- https://raw.githubusercontent.com/SanyaNya/simple-xray-core/refs/heads/main/xhttp-xray-install | bash
```
